    ...
    def selectCallable(value: Value, sym: Symbol, env: Env) = {
      new EmulatedCallableValue((args: List[Value], env: Env) => {
        ...
        sym match {
          ...
          case INT_TIMES_LONG     => binOp[Int, Long](_ * _)
          ...
          case LONG_EQEQ_INT      => binOp[Long, Int](_ == _)
          case LONG_PLUS_LONG     => binOp[Long, Long](_ + _)
          case LONG_MINUS_LONG     => binOp[Long, Long](_ - _)
          case LONG_MINUS_INT     => binOp[Long, Int](_ - _)
